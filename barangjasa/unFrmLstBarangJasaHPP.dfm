inherited frmLstBarangJasaHPP: TfrmLstBarangJasaHPP
  BorderIcons = []
  Caption = 'Barang dan Jasa HPP'
  ClientHeight = 758
  ClientWidth = 1119
  OnCreate = FormCreate
  ExplicitWidth = 1119
  ...
  object cxgBarang: TcxGrid
    ...
    object cxtbBarang: TcxGridDBTableView
      ...
      object cxtbBarangColumn2: TcxGridDBColumn
        Caption = 'HPP'
  ...
  object cxGrid1: TcxGrid
    ...
    object cxtbBarangDet: TcxGridDBTableView
      ...
      object cxtbBarangDetColumn1: TcxGridDBColumn
        Caption = 'Harga'
      ...
      object cxtbBarangDetColumn2: TcxGridDBColumn
        Caption = 'Stok Akhir'
        DataBinding.FieldName = 'sa'
        PropertiesClassName = 'TcxSpinEditProperties'
        Properties.DisplayFormat = '#,#0.00'
        HeaderAlignmentHorz = taRightJustify
      end
      object cxtbBarangDetColumn3: TcxGridDBColumn
        Caption = 'HPP'
  ...
  object zqrBarang: TZReadOnlyQuery
    ...
    SQL.Strings = (
      ...
      'LEFT JOIN tbl_hpp f ON f.id_brg = a.id'
