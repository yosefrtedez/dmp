...
type
  TfrmLstBarangJasaHPP = class(TfrmTplGrid)
    ...
    cxtbBarangColumn2: TcxGridDBColumn;
    cxtbBarangDetColumn1: TcxGridDBColumn;
    cxtbBarangDetColumn2: TcxGridDBColumn;
    cxtbBarangDetColumn3: TcxGridDBColumn;
...
var
  frmLstBarangJasaHPP: TfrmLstBarangJasaHPP;
...
procedure TfrmLstBarangJasaHPP.btnEditClick(Sender: TObject);
var
...
procedure TfrmLstBarangJasaHPP.btnHapusClick(Sender: TObject);
var
  i: integer;
begin
  inherited;
...
procedure TfrmLstBarangJasaHPP.btnRefreshClick(Sender: TObject);
begin
  inherited;
  zqrBarang.Close;
  zqrBarang.Open;
...
procedure TfrmLstBarangJasaHPP.btnTambahClick(Sender: TObject);
var
  f: TfrmInputBarangJasa;
  ts: TcxTabSheet;
begin
...
procedure TfrmLstBarangJasaHPP.Button1Click(Sender: TObject);
begin
  inherited;
  try
...
procedure TfrmLstBarangJasaHPP.btnKartuStokClick(Sender: TObject);
var
  f: TfrmKartuStok;
begin
...
procedure TfrmLstBarangJasaHPP.cxChkSatKonvClick(Sender: TObject);
begin
  inherited;
...
procedure TfrmLstBarangJasaHPP.cxtbBarangFocusedRecordChanged(
...
procedure TfrmLstBarangJasaHPP.FormCreate(Sender: TObject);
begin
  inherited;
...
procedure TfrmLstBarangJasaHPP.RefreshGrid;
begin
  btnRefreshClick(nil);
end;
