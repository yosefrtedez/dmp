...
type
  ...
  public
    ...
    property GdgBJ: Integer read mGdgBJ write mGdgBJ;
    ...
    procedure AddHistAvg(id_brg, id_ref: Integer; no_bukti: string; qty, avg, harga: Real);
...
begin
  try
    ...
    {$ELSE}
    mJudulAplikasi := 'PT. DMP - 01112018.0748';
    Self.version := '';
...
procedure TAplikasi.AddHistAvg(id_brg, id_ref: Integer; no_bukti: string; qty, avg, harga: Real);
var
  q: TZQuery;
begin
  try
